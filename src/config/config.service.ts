...
export class ConfigService {
    ...
    constructor(filePath: string) {
        ...
        Object.keys(this.envConfig).forEach((key) => {
            this.envConfig[key] = this.envConfig[key].replace(
                /\$\{([A-Za-z0-9\-_]+)\}/g,
                (root) => {
    ...
    get PORT() {
        return this.envConfig.PORT as any;
    }
    ...
    get DB_PORT() {
        return this.envConfig.DB_PORT as any;
    }
    get DB_USERNAME() {
    ...
    get DB_URI() {
        return this.envConfig.DB_URI;
    }

    get JWT_SECRET() {
        return this.envConfig.JWT_SECRET;
    }
    get JWT_SIGN_EXPIRES() {
        return this.envConfig.JWT_SIGN_EXPIRES;
    }
